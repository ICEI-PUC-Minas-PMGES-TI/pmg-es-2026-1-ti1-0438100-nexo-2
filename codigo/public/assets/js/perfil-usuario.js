...
function configurarRedirecionamento() {
    ...
    if (btnNovaDenuncia) {
        btnNovaDenuncia.onclick = function() {
            window.location.href = "./../cadastro_denuncia/cadastro_denuncia.html"; 
        };
    }
}
                    ...
                    <div class="row g-3 align-items-start h-100">
                        ...
                        <div class="col-8 d-flex flex-column h-100 justify-content-between">
                            ...
                            <div class="d-flex justify-content-end mt-auto">
                                <a href="./../detalhes/detalhes.html?id=${item.id}" class="text-decoration-none fw-bold link-details link-detalhes-zella">
                                    Ver detalhes
                                </a>
                            </div>
                        </div>
